...
public class MinMax 
{
	...
	public MOVE MinMaxEval(Game game) 
	{
		...
		for (MOVE m : possiblePacManMoves) {
			...
			int score = Min(ToGame, 0, movesAllAgents, getGhost(1));
	...
	private int Max(Game ToGame, int ply, MOVE[] movesAllAgents) 
	{
		...
		for (MOVE move : possibleMoves) 
		{
			...
			int score = Min(ToGame, ply, movesAllAgents, getGhost(1));
